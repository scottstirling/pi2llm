...
function pi2llmChatDialog(config) {
    ...
    // -- Bottom Button Panel --
    // "NEW CHAT" BUTTON
    // TODO: figure out what to do about keyboard focus going to newChatButton after the user types into the input area.
    // Either change the keyboard focus to the submit / send button or if that is not possible, have a confirmation
    // dialog for when the newChatButton is hit by accident.
    ...
    **/
    ...
    this.runInitialAnalysis = function() {
        ...
        this.addMessageToUI("system", "Analysis complete. Sending data for " + workspaceDTO.openImages.length +
