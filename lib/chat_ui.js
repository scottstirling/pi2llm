...
#define HELP_URL "https://scottstirling.github.io/pi2llm/"

var pi2llmChatDialog = class extends Dialog {
    ...
    this.helpButton.toolTip = "<p>Browse documentation for LLM Assistant.</p>";
    this.helpButton.onClick = function() {
	    if (!Dialog.browseScriptDocumentation( TITLE, "LLM Assistant" )) {
            console.writeln("Documentation not found.");
