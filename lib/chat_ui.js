...
#include <pjsr/ToolButton.jsh> // For help button type
// ** DEFINE THE DOCUMENTATION URL AT THE TOP **
// This makes it easy to update in the future.
// Point this to the raw HTML file or a GitHub Pages site.
#define DOC_URL "https://scottstirling.github.io/pi2llm/doc/scripts/LLMAssistant/LLMAssistant.html"
...
function pi2llmChatDialog(config) {
    ...
    this.helpButton.icon = this.scaledResource(":/icons/question.png"); // The standard 'Help' icon
    ...
    this.helpButton.onClick = function() {
        ...
        this.openDocumentation(DOC_URL);
    }.bind(this);
