...
function ConfigDialog(config) {
    ...
    this.helpLabel.text = "<b>pi2llm  Assistant Configuration</b><br/>" + "Configure the connection to your Large Language Model (LLM).";
    ...
    this.urlEdit.toolTip = "<p>Enter the full URL for your LLM's OpenAI-compatible chat endpoint.</p>";  // v2
    ...
    this.promptEdit.setFixedHeight(200); // v2
...
function Configuration() {
    ...
    // TODO: enable user to configure multiple URLs and select from drop-down
    ...
    // TODO: ditto for API keys and headers
    this.apiKey = "no-key";

    this.systemPrompt = "You are an expert PixInsight and astrophotography image processing assistant. \
    Analyze the following data from a PixInsight workspace. \
    It includes a list of all openImages and processIcons. \
    The activeViewId indicates the primary image of interest.  \
    Look at the relationships between image name suffix (e.g., _clone, _starless, _mask, _L, _R, _G, _B) to infer the workflow of the user. \
    ...
    Use the data to justify your recommendations. \
